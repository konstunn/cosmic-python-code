...
def test_select_order_lines_ids_unallocated(session):
    orderline_id = insert_order_line(session)
    orderline_ids = repository.select_order_lines_ids_unallocated(session)
    assert orderline_ids == [orderline_id]
